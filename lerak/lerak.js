...
const INC=2000,WAIT=30000,ANIM=420;
...
function newGame(){
  clearTimeout(botTimer);makeBoard();turn="white";selected=null;legal=[];gameOver=false;
...
function animateMove(move,done){
  ...
  const captured=move.over?b.querySelector(`[data-r="${move.over[0]}"][data-c="${move.over[1]}"] .piece`):null;
