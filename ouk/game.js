...
// Ouk Chatrang setup: the black back rank mirrors the white side, so the two center pieces are swapped on the black row.
...
function initial(){
  ...
  for(let c=0;c<8;c++){
    board[0][c]={color:"black",type:BACK_BLACK[c],moved:false};
    board[2][c]={color:"black",type:"pawn",moved:false};
    board[5][c]={color:"white",type:"pawn",moved:false};
    board[7][c]={color:"white",type:BACK_WHITE[c],moved:false};
  }
}
